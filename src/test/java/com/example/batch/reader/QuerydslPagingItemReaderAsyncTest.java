...
@SpringBootTest
public class QuerydslPagingItemReaderAsyncTest {

    private static final int TOTAL_COUNT = 10;
    private static Log logger = LogFactory.getLog(QuerydslPagingItemReaderAsyncTest.class);
    ...
    @Test
    public void querydslPagingItemReaderAsyncTest() throws Exception {
